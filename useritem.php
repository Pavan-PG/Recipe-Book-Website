<html>
    <head>
        <title><?php $servername = "localhost";
                        ...
                        $sql = "Select recipename from userrecipe where id='$id'"; 
    ...
    <body class="w3-mobile">
            <div class="w3-mobile">
              <div class="w3-bar w3-blue w3-border w3-card w3-round-large w3-large w3-top">
                ...
                <div class="w3-round-xlarge w3-pale-yellow w3-container w3-margin-left w3-margin-right w3-margin-bottom" style="margin-top:70px; padding:2px; border:5px dotted blue;">
                 <h1 style="text-align:center; font-family:Verdana;"><?php 
                        ...
                        $sql = "Select addname from userrecipe where id='$id'"; 
                        $result = $conn->query($sql);
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            echo "Contributor name : ".$row["addname"];
                         }
                     }
                     else {
                    ...
                    $conn->close();
                 ?></h1>
                    <h1 style="text-align:center; font-family:Verdana;">Recipe Details<br><br><?php $servername = "localhost";
                        $username = "id4324709_pavanroot";
                        $password = "ait15beis0361";
                        $dbname="id4324709_pavan";
                        $id = $_GET['id'];
                    ...
                    <img class="w3-round-large"  src=<?php
                        ...
                        $sql = "Select imglink from userrecipe where id='$id'"; 
                        $result = $conn->query($sql);
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            echo $row["imglink"];
            ...
            ?> alt="<?php $servername = "localhost";
                    ...
                    $conn->close(); ?>" style="width:9cm; max-height:8cm;"></div>
                    <br>
           ...
           <div class="w3-white">
               <h3 name="Title" style="text-align:center; font-family:Verdana;" class="w3-margin"><?php
                        ...
                        $sql = "Select indg from userrecipe where id='$id'"; 
                        $result = $conn->query($sql);
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            echo $row["indg"];
           ...
           <div class="w3-white">
               <h4 name="Title" style="font-family:Verdana;" class="w3-margin">
                   <?php
                        ...
                        $sql = "Select steps from userrecipe where id='$id'"; 
                        $result = $conn->query($sql);
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            echo $row["steps"];
            ...
            <h2 style="text-align:center; font-family:Verdana; margin-left:50px;" class="w3-margin w3-center"><a href="<?php
                        ...
                        $sql = "Select wikilink from userrecipe where id='$id'"; 
                        $result = $conn->query($sql);
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            echo $row["wikilink"];
                    ...
                    $conn->close();
            ?>" style="text-decoration:none;">Click here for more information on <?php $servername = "localhost";
                        $username = "id4324709_pavanroot";
                        $password = "ait15beis0361";
                        $dbname="id4324709_pavan";
                        $id = $_GET['id'];
                        ...
                        if($result->num_rows > 0) {
                         while($row = $result->fetch_assoc()){
                            $name=$row["recipename"];
                                                    ...
                                                    $sql = "SELECT revname,review FROM userrecipereviews where recipename='$name'";
                                                                        $result = $conn->query($sql);
                 ...
                 <div class="w3-round-xlarge w3-pale-yellow w3-container w3-margin-left w3-margin-right w3-margin-bottom" style="padding:2px; border:5px dotted blue;">
                  <div class="w3-card-4 w3-margin-left" style="display:inline-block;">
                    <header class="w3-container w3-blue w3-round-large">
                        <h1>Add review for the recipe <?php $servername = "localhost";
                        $username = "id4324709_pavanroot";
                        $password = "ait15beis0361";
                        $dbname="id4324709_pavan";
                        $id = $_GET['id'];
                    ...
                    <div class="w3-container w3-white w3-round-large">
                       <form action="/reviewtabuser.php/?id=<?php echo $_GET['id'];?>" method="post">
